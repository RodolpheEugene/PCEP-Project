...
# way to make the process a lot more fun.
...
def main():
    """
    Main is the major function that executes the following functions
    in the program.
    :return: This is a Void Function.
    """
    # I used "def main()" to define the line of codes below and I called it
    # at the end by writing "main()".
    ...
    for first_1 in range(4):
        print("HELLO, " * first_1)
    # I used the * string literal above to ask the program to print "Hello"
    # in 3 lines inside the "for" loop..
    print("\n")
    # Reference: https://www.w3schools.com/python/ref_string_isalpha.asp
    while True:
    ...
    while True:
        try:
            number_1 = int(input("type number: "))
            break
        except ValueError:
    ...
    while True:
        try:
            number_2 = int(input("type number: "))
            break
        except ValueError:
            print("Error. Must be a whole number.")

    simple_addition(number_1, number_2)
    user_age_for_movie(user_age)


def user_information():
    """
    The user_information function adds organization to the project. It
    separates user information from the rest of the information in the
    project.
    :return: This is a void function because it does not return a value.
    """
    ...
    print("\n")
    print("Great!!! " * 2)
    # I used the "*" string literal to command the program to
    # display "Great!!!" two times.
    print("\n")
    ...
    # the "end=" statement can be use to space out sentences as well or you
    # can input information inside the quotes too.
    ...
    # I used the "sep=" argument in the example below. the "sep=" can be
    ...
    num_second = 6
    print(
        num_first + num_second)  # I used the "+" addition operator to
    # show an example of how it can be use above.
    print("\n")
    print(
        "As demonstrated in the sentences above, this is a way the end = and "
        "sep = argument can be implemented to combine and separates sentences "
        "\n")
    # I used a  "+" string literal to combine the two strings. Python will
    # not let you combine string with an integer.
    print("Here is one instance where you can use the + string literal\n")
    year = "2000"
    year_born = "I was born in"
    num = year_born + year
    print(num)
    print("\n")
    print("This is an example of how parameter passing functions using the "
          "two values entered. \n")
    return age


# I used the def function to write a function that accepts parameters
# using simple addition.
def simple_addition(number_1, number_2):
    """
    This function is a built-in function and it used to add values together.
    :param number_1: Parameter number_1 is used to pass the first variable
    to the
    simple_addition
    function.
    :param number_2: Parameter number_2 is used to pass another variable to
    the same
    function called simple_addition.
    :return: Function does not return a value (Void Function).
    """
    ...
    first_value = False
    second_value = True
    # I used the "and" boolean operator to make a comparison between
    # two expressions.
...
def user_age_for_movie(age):
    """
    This function is used as another organization tool to separate the user
    information from the exercise where I figured out a ticket price for a
    movie depending on the age.
    :param age: This argument provides more information to the def function
    user_age_for_movie.
    :return: This is a void function.
    """
    while age != 100:
        # I used != because I am saying when the age is not 70, the person
        # have to pay a certain amount to go see the movie.
        ...
        while input_is_invalid:
            try:
                ...
                print("Input invalid. Please enter a whole number for age.")
        if 10 <= age <= 100:
            age = 100
            print("Your ticket price is $15")
            # I used a greater than, less than or equal below because if
            # the person's age is less than 10, they are supposed to pay less
            # for the movie.
        elif 1 <= age <= 10:
            age = 100
    ...
    # I used the boolean operator -not to signify that when something is
    # not true, it is false and vice versa.
    variable_1 = True
    ...
    print("\n")
    # I used a while statement to continue to ask the user for the password,
    # until the user enters the right one.
    ...
    while True:
        ...
        if password == "START" or password == "start":
            ...
            # I used -or above because I want the program to accept both
            # versions of the password START and start.
            print(
            ...
            # Reference: https://youtu.be/myJ36xIR7Yg. I used this video
            # as a reference to better understand the IF and Else arguments.
            # Question 1
            print("Question 1:")
            answer_1 = input(
                ...
                "\nA. 66 \nB. "
                "67 \nC. 69 \nD. 68 \nWhat is your answer: ")
            # I used an -if, -else statement because I want to check
            # if the user inputs the correct answer.
            if answer_1 == "67" or answer_1 == "B":
                # I used the equal "==" relational operator and "or" boolean
                # operator accept two different versions of the same answer.
                score += 1  # Reference: W3 schools, assignment Operators.
            ...
            if answer_2 == "15":
                ...
                print("Score: ", score)
                print("\n")
            # I used the conditional statements -if, -elif, -else instead
            # of the -or operator to accept two different versions of the
            # same answer.
            # I used "/" division in this example to show how it works in
            # the problem Question 3.
            print("Question 3:")
            answer_3 = input(
                "What is the solution to this expression? \n30 / 15: \nA. 1 "
                "\nB. 2 \nC. 3 \nD. 4 \nWhat is your answer: ")
            if answer_3 == "2" or answer_3 == "B":
                score += 1  # Reference: W3 schools, assignment Operators.
                # URL: https://www.w3schools.com/python/python_conditions.asp
                # I used the "+=" shortcut operator to add the total to
                # variable "total= 0". Also, I used it to look cool.
                print("Correct Answer")
                print("Score: ", score)
                print("\n")
            else:
                ...
                print("Score: ", score)
                print("\n")
            # I used "*" Multiplication in this example to show its
            ...
            # Question 5
            # I used the boolean -or operator to accept 64 and D as
            # the correct answer.
            print("Question 5:")
            answer_5 = input(
                "What is the solution to this expression? \n4 ** "
            ...
            if answer_5 == "64" or answer_5 == "D":
                ...
                print("Score: ", score)
                print("\n")
            # I used "**" Exponentiation in this example to show how
            # it functions Question 6.
            print("Question 6:")
            answer_6 = input(
                "What is the solution to this expression? \n18 // "
                "3: \nA. 6 \nB. 5 \nC. 4 \nD. 3 \nWhat is your answer: ")
            if answer_6 == "6" or answer_6 == "A":
                ...
                print("Score: ", score)
                print("\n")
            # I used "//" Floor Division operator in this
            # example to show how it
            # works.
            # Question 7
            print("Question 7:")
            answer_7 = input(
            ...
            if answer_7 == "1" or answer_7 == "B":
                ...
                print("Correct Answer")
                print("Score: ",
                      score)  # I used "%" Modulus operator in this
                # example to show how it functions.
                print("\n")
            else:
                print("Wrong Answer, The answer is 1.")
                print("Score: ", score)
                print("\n")
            # I used -if, -elif, -else statements to create a system that
            # keeps track of how many answers the user answers correct
            # and offer feedback.
            if score <= 3:
            ...
            print(num1 - num2)
            print("\n")
            # I used a Division operator to divide 30 by 15.
            ...
            print(num1 * num2)
            print("\n")
            # I used an Exponentiation operator to calculate the
            # values for 4 and 3.
            print("Question 5: Exponentiation")
            num1 = 4
            num2 = 3
            print(num1 ** num2)
            print("\n")
            # I used a Floor Division operator to calculate the
            # values 18 and 3.
            print("Question 6: Floor Division")
            num1 = 18
            num2 = 3
            print(num1 // num2)
            print("\n")
            ...
            print("\n")
            print(
                "THANK YOU! FOR PARTICIPATING IN TESTING MY STUDYING "
                "TOOL FOR THE PCEP EXAM. DON'T FORGET TO DO THE SURVEY "
                "IN THE END.\n")
